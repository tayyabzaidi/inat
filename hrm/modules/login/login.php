...
<html lang="<?php echo $lang_code; ?>" dir="<?php echo $page_direction; ?>">
    ...
    <body class="text-<?php echo $_left; ?> fade-in-top"  
          style="   
                                    ...
                                    <div class="col-lg-7">
                                        <div class="p-5">
                                            <div class="text-<?php echo $_left; ?>">
                                                <h2 class="h2 mb-4">Sign In Now!</h2>
                                            </div>
                                            ...
                                            <form class="user"
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox small">
                                                        <input type="checkbox" class="custom-control-input" name="user_remember" id="user_remember">
                                                        <label class="custom-control-label" for="user_remember">Remember Me</label>
                                                    </div>
                                                </div>

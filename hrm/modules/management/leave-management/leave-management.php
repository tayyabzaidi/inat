...
<body>
    <div class="mb-2" align="<?php echo $_right; ?>">
        ...
        ?>
        <button class="btn btn-primary" data-pdf="<?php echo $pdf_policy ?>" onclick="showPdfModal(this)">Leave
            Policy</button>
        <button type="button" class="btn btn-primary modal-button" href="#myModal2" data-toggle="modal"
            data-target="#myModal" style="margin-right: 2%;">Change Leave Policy</button>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="modal-button approve-disapprove-btn"
                                            ...
                                            style="background: none;" data-id="<?php echo $recEmpData[$i]['id']; ?>">Approve
                                            / Disapprove</button>
                                    </td>
    ...
    <div id="myModal2" class="modal">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="height: 60%;">
                <div class="modal-header">
                    <h5 class="modal-title" id="addClaimModalLabel">Leave Policy
                    </h5>
                </div>
                <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data" style="float: none;">
                        ...
                        <div class="form-group">
                            <label for="claim-pdf">PDF File (Leave Policy)</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="add-leave-policy-submit" class="btn btn-primary">Save</button>
                </div>
            </div>
            </form>
        </div>

        ...
        __table = $('#dtc_table').DataTable({
            ...
            "ajax": {
                ...
                dataFilter: function (data) {
                    ...
                    console.log(json);
                    return JSON.stringif<?php
                    $__dt_buttons_group = '<div class="btn-group  btn-group-sm" role="group" aria-label="Category Options" >'
                        . '<button  dt_btn_action="edit"    type="button" class="btn btn-sm btn-primary" style="font-size:12px;"> <i class="fa fa-edit"></i> إدارة</button>'
                        . '</div>';
                    ?>
                        < script >
                        console.log('تهيئة سكربت الموظفين....');
                    var __table;
                    var __table_url = '<?php echo __AJAX_CALL_PATH__; ?>?_path=datatable/management/employees/employees';

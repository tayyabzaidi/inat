...
/*
 * Copyright 2015
 * Presented by Zeeshan Abbas <zeeshan@iibsys.com> <+966 55 4137245>
 *
                    ...
                    <div class="col-sm-12">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <a href="<?php echo __APP_URL__ . $route->q . '/leaves'; ?>">
                                    <i class="fa fas fa-arrow-<?php echo $_right; ?>"></i>
                                    Leaves
                                </a>
                            </li>
                            <li class="list-group-item">
                                <a href="<?php echo __APP_URL__ . $route->q . '/visa'; ?>">
                                    <i class="fa fas fa-arrow-<?php echo $_right; ?>"></i>
                                    Visas
                                </a>
                            </li>
                            <li class="list-group-item">
                                <a href="<?php echo __APP_URL__ . $route->q . '/encashment'; ?>">
                                    <i class="fa fas fa-arrow-<?php echo $_right; ?>"></i>
                                    Withdrawals
                                </a>
                            </li>
                            <li class="list-group-item">
                                <a href="<?php echo __APP_URL__ . $route->q . '/salary'; ?>">
                                    <i class="fa fas fa-arrow-<?php echo $_right; ?>"></i>
                                    Salary Slips
                                </a>
                            </li>
                            <li class="list-group-item">
                                <a href="<?php echo __APP_URL__ . $route->q . '/expense'; ?>">
                                    <i class="fa fas fa-arrow-<?php echo $_right; ?>"></i>
                                    Expenses
                                </a>
                            </li>
                            ...
                            <li class="list-group-item">
                                <a href="<?php echo __APP_URL__ . $route->q . '/trips'; ?>">
                                    <i class="fa fas fa-arrow-<?php echo $_right; ?>"></i>
                                    Business Trip
                                </a>
                            </li>
                ...
                <?php if (count($rSet)) { ?>
                    <div class="row">
                        <div class="col-sm-12 p-3">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item disabled">
                                    <h5 class="p-0 m-0"><i class="fa fas fa-tasks"></i> Leave Balance</h5>
                                </li>
                                <li class="list-group-item">

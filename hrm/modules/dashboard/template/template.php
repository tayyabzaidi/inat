                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="text-center">
                                            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="<?php echo __STORAGE_URL__ . 'artwork/undraw_Source_code_re_wd9m.svg'; ?>" alt="">
                                        </div>
                                        <p>Text</p>
                                        <a target="_blank" rel="nofollow" href="#">Link &rarr;</a>
                                    </div>
                                </div>

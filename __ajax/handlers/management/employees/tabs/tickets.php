...
$__action_for = 'ticket'; //rt.type='leave'
 ...
 */
?>
<div class="tab-pane fade" id="tickets" aria-labelledby="tickets-tab" role="tabpanel" >
    <div class="container">
        <br>
        <h4>Tickets Configurations</h4>
        <hr>
        <div id="_tab_ticket_form_response"></div>
                    ...
                    <tr>
                        ...
                        <td>
                            <input  type="number" 
                                    ...
                                    style="width:100px;"
                                    min="0"
                                    onchange="__update_type_feild('<?php echo $emp_type_data[$i]['empId']; ?>', <?php echo $emp_type_data[$i]['typId']; ?>, 'ticket', 'default', this.value)"
                                    >
                        ...
                        <td>
                            <input  type="number" 
                                    ...
                                    style="width:100px;"
                                    min="0"
                                    onchange="__update_type_feild('<?php echo $emp_type_data[$i]['empId']; ?>', <?php echo $emp_type_data[$i]['typId']; ?>, 'ticket', 'current', this.value)"
                                    >
                        ...
                        <td>
                            ...
                            <input data-offstyle="danger" 
                                   ...
                                   data-toggle="toggle"  
                                   data-style="ios" 
                                   onchange="__update_type_feild('<?php echo $emp_type_data[$i]['empId']; ?>', <?php echo $emp_type_data[$i]['typId']; ?>, 'ticket', 'entitment', this.checked)"
                                   >

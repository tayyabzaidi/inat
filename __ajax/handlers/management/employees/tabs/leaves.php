...
$__action_for = 'leave'; //rt.type='leave'
 ...
 */
?>
<div class="tab-pane fade" id="leaves" aria-labelledby="leaves-tab" role="tabpanel" >
    <div class="container">
        <br>
        <h4>Leaves Configurations</h4>
        <hr>
        <div id="_tab_leave_form_response"></div>
                    ...
                    <tr>
                        ...
                        <td>
                            <input  type="number" 
                                    ...
                                    style="width:100px;"
                                    min="0"
                                    onchange="__update_type_feild('<?php echo $emp_type_data[$i]['empId']; ?>', <?php echo $emp_type_data[$i]['typId']; ?>, 'leave', 'default', this.value)"
                                    >
                        ...
                        <td>
                            <input  type="number" 
                                    ...
                                    style="width:100px;"
                                    min="0"
                                    onchange="__update_type_feild('<?php echo $emp_type_data[$i]['empId']; ?>', <?php echo $emp_type_data[$i]['typId']; ?>, 'leave', 'current', this.value)"
                                    >
                        ...
                        <td>
                            ...
                            <input data-offstyle="danger" 
                                   ...
                                   data-toggle="toggle"  
                                   data-style="ios" 
                                   onchange="__update_type_feild('<?php echo $emp_type_data[$i]['empId']; ?>', <?php echo $emp_type_data[$i]['typId']; ?>, 'leave', 'entitment', this.checked)"
                                   >

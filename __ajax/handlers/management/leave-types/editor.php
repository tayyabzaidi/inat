...
<form name="_edit_record_modal_form" 
      ...
      method="POST" 
      action=""
      onsubmit="_ajaxCall('_edit_record_modal_form', 'management/leave-types/update'); return false;"
      >

    <div class="modal-header">
        <h4 class="modal-title" id="_create_record_modal_label">Edit Leave Type</h4>

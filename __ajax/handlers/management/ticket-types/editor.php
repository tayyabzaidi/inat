...
<form name="_edit_record_modal_form" 
      ...
      method="POST" 
      action=""
      onsubmit="_ajaxCall('_edit_record_modal_form', 'management/ticket-types/update'); return false;"
      >

    <div class="modal-header">
        <h4 class="modal-title" id="_create_record_modal_label">Edit Ticket Type</h4>
    ...
    <div class=" p-3">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                <label for="e_days">Allowed Tickets</label>
                <input  type="number" 
